...
/***/ "./node_modules/enquire-js/index.jsx":
/*!*******************************************!*\
  !*** ./node_modules/enquire-js/index.jsx ***!
  \*******************************************/
/*! exports provided: enquireScreen, unenquireScreen, default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "enquireScreen", function() { return enquireScreen; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "unenquireScreen", function() { return unenquireScreen; });
let enquireJs;
...
/* harmony default export */ __webpack_exports__["default"] = (enquireJs);
...
var scroll = __webpack_require__(/*! ./modules/scroll */ "./resources/js/modules/scroll.js");

var magic = __webpack_require__(/*! ./modules/magic */ "./resources/js/modules/magic.js");

var cookies = __webpack_require__(/*! ./modules/cookies */ "./resources/js/modules/cookies.js");
...
var gdprCookies = __webpack_require__(/*! ../modules/gdpr-cookie */ "./resources/js/modules/gdpr-cookie.js");
...
var cookie_options = {
  sl: {
    cookieTypes: [{
      type: "Nujni",
      value: "essential",
      description: "Piškotki, ki so ključni za delovanje spletnega mesta (vedno nameščeni).",
      checked: true
    }, {
      type: "Analitični",
      value: "analytics",
      description: "Piškotki, povezani z obiskom spletnih strani, vrstami brskalnikov itd.",
      checked: true
    }],
    title: "Politika piškotkov",
    subtitle: "Izberite piškotke",
    message: "Spletno mesto uporablja piškotke z namenom zagotavljanja najbolj optimalne uporabniške izkušnje. Z nadaljnjim brskanjem po spletnem mestu se strinjate z uporabo piškotkov. Več o piškotkih si lahko preberete <a href='/sl/politika-piskotkov'>tukaj</a>.",
...
$.gdprcookie.init(cookie_options[document.documentElement.lang]);

/***/ }),

/***/ "./resources/js/modules/gdpr-cookie.js":
/*!*********************************************!*\
  !*** ./resources/js/modules/gdpr-cookie.js ***!
  \*********************************************/
/*! no static exports found */
...
(function (root, factory) {
  ...
  var validateCookieName = function validateCookieName(name) {
  ...
  $.gdprcookie.init = function (options) {
    ...
    settings = $.extend(defaultSettings, window.GdprCookieSettings, options); // Coerce into a string because this is poured into innerHTML

    settings.message = String(settings.message); // Coerce into a positive number because it is passed to setTimeout

    settings.delay = Math.max(0, +settings.delay) || 0; // Coerce into a positive whole number between 0 and 730 (2-ish years), to ensure a well-formed cookie value

    settings.expires = Math.round(Math.min(Math.max(0, +settings.expires), 730)) || 0; // Coerce cookieTypes into an array containing plain objects
  ...
  display = function display(alwaysShow) {
    if (showing) {
      return;
    }
    ...
    var hide = function hide(canreload) {
    ...
    if (alwaysShow || !myCookiePrefs) {
      elements.types = $("<div class='bottomBar-wrapper'/>").append($.map(settings.cookieTypes, function (field, index) {
        ...
        return $("<div class='cookieElement'/>").append([input.get(0), label.get(0)]).get(0);
      }));
      elements.allChecks = $(elements.allChecks);
      elements.nonessentialChecks = $(elements.nonessentialChecks); // When accept button is clicked drop cookie

      var acceptClick = function acceptClick() {
        // Hide the cookie message
        hide(true); // Save user cookie preferences (in a cookie!)
        ...
        setCookie(settings.cookieName, JSON.stringify(prefs), settings.expires); // Trigger cookie accept event

        body.trigger("gdpr:accept");
      }; // Toggle advanced cookie options


      var advancedClick = function advancedClick() {//elements.buttons.advanced.prop("disabled", true);
      ...
      var cookieMessage = (elements.container = $("<div class='gdpr__cookie'></div>")).append([$("<div class='gdpr__cokie-wrapper'></div>").append([$("<div class='topBar'></div>").append([$("<div class='topBar-wrapper'></div>").append([$("<div class='text'></div>").append([$("<p/>", {
        html: settings.message
      }).get(0)]), $("<div class='buttons'></div>").append([$("<div class='toggle'></div>").append([$("<span/>", {
        type: "button",
        text: settings.advancedBtnLabel,
        click: advancedClick
      }).get(0)]), $("<div class='btn'></div>").append([$("<button/>", {
        type: "button",
        text: settings.acceptBtnLabel,
        click: acceptClick
      }).get(0)])])])]), $("<div class='bottomBar'></div>").append([elements.types.get(0)]), $("<div class='btn-mobile'></div>").append([$("<button/>", {
        type: "button",
        text: settings.acceptBtnLabel,
        click: acceptClick
      }).get(0)])])]);
    ...
    if (myCookiePrefs === undefined) {
      myCookiePrefs = settings.cookieTypes.map(function (type) {
        return type.checked ? type.value : null;
      });
      noshow = true;
    }

    $.each(myCookiePrefs, function (i, v) {
      if ($.gdprcookie.preference(v) === true || noshow) {
        // $('script[type="text/plain"][data-gdprcookie="' + v + '"]').each(function() {
        $('script[type="text/plain"].cc-onconsent' + v).each(function () {
          if ($(this).attr('src')) {
...
/***/ "./resources/js/modules/gistfilel.js":
/*!*******************************************!*\
  !*** ./resources/js/modules/gistfilel.js ***!
  \*******************************************/
/*! no exports provided */
...
jquery__WEBPACK_IMPORTED_MODULE_0___default.a.extend(true, jquery__WEBPACK_IMPORTED_MODULE_0___default.a.magnificPopup.defaults, {
    ...
    patterns: {
      youtube: {
        ...
        id: function id(src) {
          // link pattern
          var mt = src.match(/v=([^&]+)(&(.*))?/);
          if (mt) return mt[1] + '?' + mt[3]; // embed pattern
  ...
  callbacks: {
    beforeOpen: function beforeOpen() {
      if (jquery__WEBPACK_IMPORTED_MODULE_0___default()(window).width() < 700) this.st.focus = false;
    }
  }
});
...
/* harmony import */ var magnific_popup__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! magnific-popup */ "./node_modules/magnific-popup/dist/jquery.magnific-popup.js");
/* harmony import */ var magnific_popup__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(magnific_popup__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _gistfilel__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./gistfilel */ "./resources/js/modules/gistfilel.js");
/* Script where some of the magic happens */
// Variables
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).ready(function () {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('body').on('click', '.gdpr__cookie .topBar .toggle span', function () {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).closest('.gdpr__cookie').toggleClass('show-more');
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).closest('.topBar').siblings('.bottomBar').slideToggle();
  });
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.cookie-popup').on('click', function (e) {
    e.preventDefault();
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('body').addClass('overlay-active');
  });
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.overlay .overlay-close').on('click', function () {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('body').removeClass('overlay-active');
  });
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('body').on('click', '.gdpr__cookie .topBar .text a', function (e) {
    e.preventDefault();
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('body').addClass('overlay-active');
  });
  var theLanguage = jquery__WEBPACK_IMPORTED_MODULE_0___default()('html').attr('lang');
  var loadingLang;

  if (theLanguage == 'sl') {
    loadingLang = 'Nalaganje ...';
  } else {
    loadingLang = 'Loading ...';
  }

  if (document.querySelectorAll('.gallerySection').length) {
    Promise.resolve(/*! import() */).then(__webpack_require__.t.bind(null, /*! magnific-popup */ "./node_modules/magnific-popup/dist/jquery.magnific-popup.js", 7)).then(function (module) {
      jquery__WEBPACK_IMPORTED_MODULE_0___default()('.gallerySection .image--pop').magnificPopup({
        tLoading: loadingLang,
        type: 'image',
  ...
  if (document.querySelectorAll('.videoSection').length) {
    Promise.resolve(/*! import() */).then(__webpack_require__.t.bind(null, /*! magnific-popup */ "./node_modules/magnific-popup/dist/jquery.magnific-popup.js", 7)).then(function (module) {
      jquery__WEBPACK_IMPORTED_MODULE_0___default()('.videoSection .video--pop').magnificPopup({
        tLoading: loadingLang,
        type: 'iframe',
        closeOnContentClick: true,
        closeBtnInside: false,
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.gallerySection').each(function () {// $(this).find('.image--pop').magnificPopup({
    //         // delegate: 'a',
    //         tLoading: loadingLang,
    //         type: 'image',
    //         closeOnContentClick: true,
  ...
  function iframeResizes() {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.gallerySlide .video').each(function () {
      jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).find('iframe').attr('width', '100%');
      var riddleWidth = 0;
      var riddleWidth = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).find('iframe').width();
      var riddleHeight = riddleWidth * 0.75;
      jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).find('iframe').height(riddleHeight);
    });
  }
...
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery.js");
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(jquery__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _scrolloverflow_min__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./scrolloverflow.min */ "./resources/js/modules/scrolloverflow.min.js");
/* harmony import */ var _scrolloverflow_min__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_scrolloverflow_min__WEBPACK_IMPORTED_MODULE_1__);
...
/* harmony import */ var enquire_js_index__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! enquire-js/index */ "./node_modules/enquire-js/index.jsx");
/* Script where scroll events happen */
// Variables
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).ready(function () {
  enquire_js_index__WEBPACK_IMPORTED_MODULE_3__["default"].register('screen and (min-width:900px)', {
    match: function match() {
      new fullpage_js__WEBPACK_IMPORTED_MODULE_2___default.a('#fullpage', {
        licenseKey: 'AA42F362-73CD49A8-9658FD3C-E36D9802',
        // normalScrollElements: '.eightSection',
...
function detectmob() {
  if (navigator.userAgent.match(/Android/i) || navigator.userAgent.match(/webOS/i) || navigator.userAgent.match(/iPhone/i) || navigator.userAgent.match(/iPad/i) || navigator.userAgent.match(/iPod/i) || navigator.userAgent.match(/BlackBerry/i) || navigator.userAgent.match(/Windows Phone/i)) {
    fullpage_api.destroy('all');
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(".firstSection .quickLinks a").click(function (e) {
      e.preventDefault();
      var anchor = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).attr('data-attr-scroll');
      jquery__WEBPACK_IMPORTED_MODULE_0___default()('html,body').animate({
        scrollTop: jquery__WEBPACK_IMPORTED_MODULE_0___default()('#' + anchor).offset().top
      }, 500);
    });
    return true;
  } else {// new fullPage('#fullpage', {
    //
    //     licenseKey: 'AA42F362-73CD49A8-9658FD3C-E36D9802',
    //     // normalScrollElements: '.eightSection',
    //     anchors: ['section1', 'section2', 'section3', 'section4', 'section5', 'section6', 'section7', 'section8', 'section9'],
...
detectmob();
jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).on('click', '.scrollDown', function () {
  fullpage_api.moveSectionDown();
});

/***/ }),

/***/ "./resources/js/modules/scrolloverflow.min.js":
/*!****************************************************!*\
  !*** ./resources/js/modules/scrolloverflow.min.js ***!
  \****************************************************/
/*! no static exports found */
...
__webpack_require__(/*! /Users/bratej/Kreatorij/bagola/resources/js/app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! /Users/bratej/Kreatorij/bagola/resources/sass/app.scss */"./resources/sass/app.scss");
